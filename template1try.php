...
<div class="info" style="background-color:whitesmoke;color:black;text-align:left;margin-left:300px;margin-right:300px;" widht=2000px height=3000px>
<div class="name" style="background-color:rgb(54, 54, 183);color:white;display:flex;"  height=250px >
  <div>
      <!--<input type="text" id=fnameresult>
  <input type="text" id="result">
  <span  id="result"> </span>
  -->
       <h1 style="font-style:verdana;font-size:60px;margin-left:100px;">Your Name</h1><br>
       <p style="margin-left:100px;"><b>ADDRESS:</b> New Delhi ,India,112087<h5 ></h5>
             <span id="resultAddress"> </span></p>
       <p style="margin-left:100px;"><b>PHONE:</b><p id="resultNumber"> +91 22 12345677 </p> </p>
       <p style="margin-left:100px;"><b>EMAIL:</b> <span id="resultEmail"> mishra.varun@gamil.com</span></p>
  </div>
  <div>
    <img src="Images/avatar6.jpg" alt="Avatar" class="avatar" style="margin-left:290px;" width=300px height=300px>
  </div>
</div>
  
<form action="/action_page.php" method="post">

<div class="container" style="background-color:white;color:black;margin-left:100px;" widht=2000px height=1500px>
   <div><p>Motivated sales associated with 5 years of experience bossting sales and customer loyalty through 
  ...
  <div class="skills" >
     <div class="logo" style="display:flex;">
      ...
      <div>
        <h2 style="color:rgb(54, 54, 183);">SKILLS</h2>
      </div>
    </div>
    <div>
  ...
  <div class="work">
    <div class="logo2" style="display:flex;">
       ...
       <div>
          <h2 style="color:rgb(54, 54, 183);"> WORK HISTORY </h2>
       </div>
    </div>
  ...
  <div class="education">
    <div class="logo2" style="display:flex;">
       ...
       <div>
          <h2 style="color:rgb(54, 54, 183);"> EDUCATION </h2>
       </div>
    </div>
    <div class="UG">
