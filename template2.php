...
<div class="info" style="background-color:whitesmoke;color:black;text-align:left;margin-left:300px;margin-right:300px;" >
<div class="name" style="background-color:rgb(46, 40, 40);color:white;"  height=130px >
       <h1 style="font-style:verdana;font-size:60px;margin-left:60px;margin-top:40px;">Varun Sharma</h1><br>
</div>
<form action="/action_page.php" method="post">
<div class="demo" style="display:flex;">
  <div class="container" style="background-color:white;color:black;margin-left:100px;margin-top:30px;padding:50px;" widht=750px >
...
<!-----------contact details------------------->
  <div class ="demo" style="background-color:whitesmoke;padding:40px;" width=150px>
     <div class="contact" style="margin-top:30px;">
      <div class="logo" style="display:flex;">
        ...
        <div>
           <p style="margin-left:40px;"><b>ADDRESS:</b> New Delhi ,India,112087</p>
           <p style="margin-left:40px;"><b>PHONE:</b> +91 22 12345677</p>
           <p style="margin-left:40px;"><b>EMAIL:</b> mishra.varun@gamil.com</p>
        </div>
     </div>
